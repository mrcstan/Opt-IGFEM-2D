function stop = outfun_blocked_channels(x,optimValues,state)
    ...
    switch state
         ...
         case 'iter'
            ...
            G_history.fval = [G_history.fval, optimValues.fval*G_out.objScale];
            %G_history.maxfval = [G_history.maxfval; optimValues.maxfval*G_out.objScale+G_out.objOffset];
            G_history.maxSet = [G_history.maxSet,G_out.maxSet];
            ...
            G_history.cstr = [G_history.cstr,G_constraint];
            ...
            if ~strcmpi(G_out.costFuncType,'P_NORM')
                ...
                G_history.Tpnorm  = [G_history.Tpnorm; ...
                                    G_constraint(end-G_history.nMaxObjs+G_out.maxSet)*G_out.objScale+G_history.x(end)];
            end  
