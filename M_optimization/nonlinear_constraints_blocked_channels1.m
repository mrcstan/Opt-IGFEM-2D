...
if (PmaxConOn && TmaxConOn)
    ...
    sensitivityPTAV.costFunction.objOpt.calcOneNorm = true;
elseif PmaxConOn || PminConOn  
    ...
    sensitivityPTAV.costFunction.area = nlcon.area;
elseif TmaxConOn
    ng = ng + 1;
    Tind = ng;
    sensitivityPTAV.costFunction.type = 'P_NORM';
...
if (nargout > 2)
    ...
    if (PmaxConOn && TmaxConOn)
        ...
        [nu,DTnu] = kinematic_viscosity(channels.viscosity,channels.density,...
        ...
        g(Pind) = (pressure(channels.inletEndPoint) ...
                    -pressure(channels.pressureOutletEndPoint))/nlcon.maxP-1.0;
        ...
        gradg(1:designParams.nParams,Pind) ...
